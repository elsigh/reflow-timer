...
ReflowTimer.prototype.run = function() {
  ...
  if (this.showFeedbackDuringTests_) {
    var $container = $('<div id="rt-feedback" class="rt-feedback">');
    var $feedback = $('<div>');
    $container.append($feedback);

    this.testFeedbackEl_ = $feedback.get(0);
    $feedback.html('Beginning the Reflow tests...');
    this.body_.appendChild($container.get(0));
  }
...
ReflowTimer.prototype.test_ = function() {
  ...
  window.console.log('reflowTime', reflowTime, time2, time1);
